...
//gsoap ns service name: conversion
//gsoap ns service style: document
//gsoap ns service encoding: literal
//gsoap ns service port: http://localhost:8080
//gsoap ns service namespace: urn:conversion

int ns__conversionByteArray (ByteArray in, unsigned long& seq_num);

int ns__conversionNestedArray (ComplexType in, unsigned long& seq_num);
