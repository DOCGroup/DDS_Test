...
PubMessageTypeSupportImpl::PubMessageTypeSupportImpl (void)
{
}
...
DDS::ReturnCode_t
PubMessageTypeSupportImpl::register_type (
...
PubMessageTypeSupportImpl::create_datawriter (
...
{
    PubMessageDataWriterImpl* writer_impl;
...
PubMessageTypeSupportImpl::create_datareader (
    ACE_ENV_SINGLE_ARG_DECL
  )
  ACE_THROW_SPEC ((
    CORBA::SystemException
...
{
    PubMessageDataReaderImpl* reader_impl;
    ACE_NEW_RETURN(reader_impl, 
                    PubMessageDataReaderImpl(), 
...
// Implementation skeleton constructor
PubMessageDataWriterImpl::PubMessageDataWriterImpl (void)
: marshaled_size_ (0),
  db_lock_pool_(0),
  data_allocator_ (0),
  mb_allocator_ (0),
...
PubMessageDataWriterImpl::_cxx_register (
...
DDS::InstanceHandle_t 
PubMessageDataWriterImpl::register_w_timestamp (
    const ::DDSPerfTest::PubMessage & instance_data,
  ...
  ))
{
  ...
  if (ret != ::DDS::RETCODE_OK)
  {
      ACE_ERROR ((LM_ERROR, 
                  ACE_TEXT("(%P|%t) ")
                  ACE_TEXT("PubMessageDataWriterImpl::register_w_timestamp, ")
...
DDS::ReturnCode_t
PubMessageDataWriterImpl::unregister (
    const ::DDSPerfTest::PubMessage & instance_data,
    ::DDS::InstanceHandle_t handle
    ACE_ENV_ARG_DECL
  )
...
DDS::ReturnCode_t
PubMessageDataWriterImpl::unregister_w_timestamp (
    const ::DDSPerfTest::PubMessage & instance_data,
    ::DDS::InstanceHandle_t handle,
    const ::DDS::Time_t & source_timestamp
    ACE_ENV_ARG_DECL
  ...
  ))
{
  ...
  if(registered_handle == ::TAO::DCPS::HANDLE_NIL)
  {
    ...
    ACE_ERROR_RETURN ((LM_ERROR, 
                        ACE_TEXT("(%P|%t) ")
                        ACE_TEXT("PubMessageDataWriterImpl::unregister, ")
  ...
  {
    // DataWriterImpl::unregister will call back to inform the PubMessageDataWriter
    // that the instance handle is removed from there and hence PubMessageDataWriter
...
DDS::ReturnCode_t
PubMessageDataWriterImpl::write (
    const ::DDSPerfTest::PubMessage & instance_data,
    ::DDS::InstanceHandle_t handle
    ACE_ENV_ARG_DECL
  )
...
DDS::ReturnCode_t
PubMessageDataWriterImpl::write_w_timestamp (
    const ::DDSPerfTest::PubMessage & instance_data,
    ::DDS::InstanceHandle_t handle,
    const ::DDS::Time_t & source_timestamp
    ACE_ENV_ARG_DECL
  ...
  ))
{
  ...
  if (handle == ::DDS::HANDLE_NIL)
  {
    ...
    if (ret != ::DDS::RETCODE_OK)
    {
      ACE_ERROR ((LM_ERROR, 
                  ACE_TEXT("(%P|%t) ")
                  ACE_TEXT("PubMessageDataWriterImpl::write, ")
...
DDS::ReturnCode_t
PubMessageDataWriterImpl::dispose (
    const ::DDSPerfTest::PubMessage & instance_data,
...
DDS::ReturnCode_t
PubMessageDataWriterImpl::dispose_w_timestamp (
    const ::DDSPerfTest::PubMessage & instance_data,
    ::DDS::InstanceHandle_t instance_handle,
    const ::DDS::Time_t & source_timestamp
    ACE_ENV_ARG_DECL
  ...
  ))
{
  ...
  if(instance_handle == ::TAO::DCPS::HANDLE_NIL) 
  {
    ...
    if (instance_handle == ::TAO::DCPS::HANDLE_NIL) 
    {
      ACE_ERROR_RETURN ((LM_ERROR, 
                          ACE_TEXT("(%P|%t) ")
                          ACE_TEXT("PubMessageDataWriterImpl::dispose, ")
...
DDS::ReturnCode_t
PubMessageDataWriterImpl::get_key_value (
...
::DDS::ReturnCode_t 
PubMessageDataWriterImpl::enable_specific (
    ACE_ENV_SINGLE_ARG_DECL
  )
  ACE_THROW_SPEC ((
    CORBA::SystemException
  ))
{
  ...
  if (_tao_is_bounded_size (data))
  {
    ...
    if (::TAO::DCPS::DCPS_debug_level >= 2)
      ACE_DEBUG((LM_DEBUG,"(%P|%t) PubMessageDataWriterImpl::enable_specific-data"
  ...
  {
    if (::TAO::DCPS::DCPS_debug_level >= 2)
      ACE_DEBUG((LM_DEBUG,"(%P|%t) PubMessageDataWriterImpl::enable_specific"
  ...
  if (::TAO::DCPS::DCPS_debug_level >= 2)
    {
      ACE_DEBUG((LM_DEBUG,"(%P|%t) PubMessageDataWriterImpl::enable_specific-mb"
          " Cached_Allocator_With_Overflow %x with %d chunks\n",
          mb_allocator_, n_chunks_));
      ACE_DEBUG((LM_DEBUG,"(%P|%t) PubMessageDataWriterImpl::enable_specific-db"
          " Cached_Allocator_With_Overflow %x with %d chunks\n",
...
// Note: The PubMessageDataWriter gives ownership of the marshalled data 
//       to the WriteDataContainer.
ACE_Message_Block*
 PubMessageDataWriterImpl::marshal(
                const ::DDSPerfTest::PubMessage& instance_data,
                int  for_write)
{
  ...
  { // Don't use the cached allocator for the registered sample message
    ...
    ACE_NEW_RETURN (mb,
                    ACE_Message_Block (sizeof (::DDSPerfTest::PubMessage)),
                    0);
  }
...
::DDS::ReturnCode_t
 PubMessageDataWriterImpl::get_or_create_instance_handle(
                DDS::InstanceHandle_t& handle,
      ...
      if (pair.second == false)
        {
          ACE_ERROR_RETURN ((LM_ERROR, 
                              ACE_TEXT("(%P|%t) "
                              "PubMessageDataWriterImpl::get_or_create_instance_handle, ")
                              ACE_TEXT("insert DDSPerfTest::PubMessage failed. \n")),
                              ::DDS::RETCODE_ERROR);
        }
    }
    else
...
::DDS::InstanceHandle_t 
 PubMessageDataWriterImpl::get_instance_handle(
                ::DDSPerfTest::PubMessage instance_data)
{
  InstanceMap::const_iterator it = instance_map_.find(instance_data);
...
void
PubMessageDataWriterImpl::unregistered(::DDS::InstanceHandle_t   instance_handle)
{
...
// Implementation skeleton constructor
PubMessageDataReaderImpl::PubMessageDataReaderImpl (void)
{

}

void
PubMessageDataReaderImpl::init (
        TopicImpl*                    a_topic,
...
::DDS::ReturnCode_t 
PubMessageDataReaderImpl::enable_specific (
    ACE_ENV_SINGLE_ARG_DECL
  )
  ACE_THROW_SPEC ((
    CORBA::SystemException
  ))
{
  data_allocator_ = new DataAllocator(get_n_chunks ()) ;
    if (::TAO::DCPS::DCPS_debug_level >= 2)
      ACE_DEBUG((LM_DEBUG,"PubMessageDataReaderImpl::enable_specific-data"
          " Cached_Allocator_With_Overflow %x with %d chunks\n",
      ...
      while (ptr->rcvd_sample_.size_)
        {
         ...
         ::DDSPerfTest::PubMessage* delete_ptr = static_cast< ::DDSPerfTest::PubMessage* >(head_ptr->registered_data_);
...
DDS::ReturnCode_t
PubMessageDataReaderImpl::delete_contained_entities (
    ACE_ENV_SINGLE_ARG_DECL
  )
  ACE_THROW_SPEC ((
    CORBA::SystemException
  ...
  ))
{
  ...
  if (received_data.maximum() == 0)
    {
      ::DDSPerfTest::PubMessage *buf;
      ::DDS::SampleInfo *info;
      buf = new ::DDSPerfTest::PubMessage[max_samples];
       ...
       it ++)
  {
        ...
        (ptr->instance_state_.instance_state() & instance_states))
    {
           ...
           item != 0 ; item = item->next_data_sample_)
      {
        ...
        {
          received_data[count] =
              *((::DDSPerfTest::PubMessage *)item->registered_data_) ;
          ...
          if (item->sample_state_ & sample_states)
            {
              ...
              if (item == ptr->rcvd_sample_.tail_)
              ...
              else
                {
                 ...
                 ::DDSPerfTest::PubMessage* delete_ptr = static_cast< ::DDSPerfTest::PubMessage* >(item->registered_data_);
                  ACE_DES_FREE (delete_ptr,
                                data_allocator_->free,
                                PubMessage );
                  ACE_DES_FREE (item,
        ...
        if (tail)
          {
            ...
            ::DDSPerfTest::PubMessage* delete_ptr = static_cast< ::DDSPerfTest::PubMessage* >(tail->registered_data_);
            ACE_DES_FREE (delete_ptr,
                          data_allocator_->free,
                          PubMessage );
            ACE_DES_FREE (tail,
...
DDS::ReturnCode_t
PubMessageDataReaderImpl::read_next_sample (
  ...
  ))
{
  ...
  FILE* fp =
    ACE_OS::fopen ("PubMessage.txt", ACE_LIB_TEXT("r"));
  if (fp == 0)
  {
    ACE_ERROR_RETURN ((LM_ERROR, 
                        ACE_TEXT("(%P|%t) ")
                        ACE_TEXT("PubMessageDataReaderImpl::read_next_sample, ")
                        ACE_TEXT("Unable to open PubMessage.txt for reading: %p\n"),
                        "fopen"),
                        ::DDS::RETCODE_ERROR);
  }
  ...
  ::PubMessageSeq received_data_seq(1) ;
...
DDS::ReturnCode_t
PubMessageDataReaderImpl::take_next_sample (
    ::DDSPerfTest::PubMessage & received_data,
    ::DDS::SampleInfo & sample_info
    ACE_ENV_ARG_DECL
  )
...
DDS::ReturnCode_t
PubMessageDataReaderImpl::read_instance (
    ::PubMessageSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
...
DDS::ReturnCode_t
PubMessageDataReaderImpl::take_instance (
    ::PubMessageSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
DDS::ReturnCode_t
PubMessageDataReaderImpl::read_next_instance (
    ::PubMessageSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
DDS::ReturnCode_t
PubMessageDataReaderImpl::take_next_instance (
    ::PubMessageSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
DDS::ReturnCode_t
PubMessageDataReaderImpl::return_loan (
    ::PubMessageSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq
    ACE_ENV_ARG_DECL
  )
  ...
  ))
{
  ...
  {
    ::DDSPerfTest::PubMessage *buf = received_data.get_buffer();
...
DDS::ReturnCode_t 
PubMessageDataReaderImpl::get_key_value (
    ::DDSPerfTest::PubMessage & key_holder,
    ::DDS::InstanceHandle_t handle
    ACE_ENV_ARG_DECL
  )
...
void
PubMessageDataReaderImpl::demarshal(const ReceivedDataSample& sample)
{
  ::DDSPerfTest::PubMessage *data /* = new ::DDSPerfTest::PubMessage(instance_data) */ ;
  
  ACE_NEW_MALLOC_NORETURN (data,
                         static_cast< ::DDSPerfTest::PubMessage *> (
                         data_allocator_->malloc (
                              sizeof (::DDSPerfTest::PubMessage))),
...
::DDS::ReturnCode_t
PubMessageDataReaderImpl::store_instance_data(
    ::DDSPerfTest::PubMessage *instance_data,
        ...
        this->qos_.resource_limits.max_samples_per_instance))
    {
      if  (instance_ptr->rcvd_sample_.head_->sample_state_ 
       ...
       else
       {
         ...
         ::DDSPerfTest::PubMessage* ptr = static_cast< ::DDSPerfTest::PubMessage* >(item->registered_data_);
         ACE_DES_FREE (ptr,
                       data_allocator_->free,
                       PubMessage );
...
void 
PubMessageDataReaderImpl::dispose(const ReceivedDataSample& sample)
{
  //!!! caller should already have the sample_lock_
  ...
  else
  {
    ACE_ERROR((LM_ERROR, 
              ACE_TEXT("(%P|%t) ")
              ACE_TEXT("PubMessageDataReaderImpl::disposed, ")
              ACE_TEXT("The instance is not registered.\n")));
  }
...
//TAO::DCPS::DataReaderRemote_ptr
//PubMessageDataReaderImpl::get_datareaderremote_obj_ref ()
//{
//  ::TAO::DCPS::DataReaderRemote_ptr reader_obj 
//      = ::TAO::DCPS::servant_to_reference<TAO::DCPS::DataReaderRemote, 
//                                          PubMessageDataReaderImpl, 
