...
echo "step 6: Updating WWW repository.."
...
echo "<tr><td>RTI 4.1e</td><td>build_RTI.sh </td><td bgcolor=\"lime\">[<a href=\"http://www.dre.vanderbilt.edu/DDS/html/BUILD/RTI_BUILD_RESULT\">Full</a>] </td><td bgcolor=\"white\">N/A</td><td bgcolor=\"white\">N/A</td></tr>" >> $INDEX_FILE
