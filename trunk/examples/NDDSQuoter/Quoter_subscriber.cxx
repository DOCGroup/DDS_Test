...
void QuoterListener::on_data_available(DDSDataReader* reader)
{
    ...
    for (i = 0; i < data_seq.length(); ++i) {
        if (info_seq[i].valid_data) {
            ...
            // Modified by jhoffert just to change up the default output
            const Quoter &sub_data = data_seq[i];
            std::cout << "Stock price for " << sub_data.symbol
                      << " is " << sub_data.price << std::endl;
        }
    }
