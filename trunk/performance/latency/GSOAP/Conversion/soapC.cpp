...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.7.6c 2005-11-29 20:30:54 GMT")
...
SOAP_FMAC3 void * SOAP_FMAC4 soap_getelement(struct soap *soap, int *type)
{
	...
	case SOAP_TYPE_ns__conversionNestedArray:
		return soap_in_ns__conversionNestedArray(soap, NULL, NULL, "ns:conversionNestedArray");
	case SOAP_TYPE_ns__conversionNestedArrayResponse:
		return soap_in_ns__conversionNestedArrayResponse(soap, NULL, NULL, "ns:conversionNestedArrayResponse");
	case SOAP_TYPE_ns__conversionByteArray:
		return soap_in_ns__conversionByteArray(soap, NULL, NULL, "ns:conversionByteArray");
	case SOAP_TYPE_ns__conversionByteArrayResponse:
		return soap_in_ns__conversionByteArrayResponse(soap, NULL, NULL, "ns:conversionByteArrayResponse");
	...
	{	const char *t = soap->type;
		...
		if (!soap_match_tag(soap, t, "ns:conversionNestedArray"))
		{	*type = SOAP_TYPE_ns__conversionNestedArray;
			return soap_in_ns__conversionNestedArray(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "ns:conversionNestedArrayResponse"))
		{	*type = SOAP_TYPE_ns__conversionNestedArrayResponse;
			return soap_in_ns__conversionNestedArrayResponse(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "ns:conversionByteArray"))
		{	*type = SOAP_TYPE_ns__conversionByteArray;
			return soap_in_ns__conversionByteArray(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "ns:conversionByteArrayResponse"))
		{	*type = SOAP_TYPE_ns__conversionByteArrayResponse;
			return soap_in_ns__conversionByteArrayResponse(soap, NULL, NULL, NULL);
		}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_putelement(struct soap *soap, const void *ptr, const char *tag, int id, int type)
{
	...
	case SOAP_TYPE_ns__conversionNestedArray:
		return soap_out_ns__conversionNestedArray(soap, tag, id, (const struct ns__conversionNestedArray *)ptr, "ns:conversionNestedArray");
	case SOAP_TYPE_ns__conversionNestedArrayResponse:
		return soap_out_ns__conversionNestedArrayResponse(soap, tag, id, (const struct ns__conversionNestedArrayResponse *)ptr, "ns:conversionNestedArrayResponse");
	case SOAP_TYPE_ns__conversionByteArray:
		return soap_out_ns__conversionByteArray(soap, tag, id, (const struct ns__conversionByteArray *)ptr, "ns:conversionByteArray");
	case SOAP_TYPE_ns__conversionByteArrayResponse:
		return soap_out_ns__conversionByteArrayResponse(soap, tag, id, (const struct ns__conversionByteArrayResponse *)ptr, "ns:conversionByteArrayResponse");
	case SOAP_TYPE_ComplexType:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	case SOAP_TYPE_SOAP_ENV__Reason:
		...
		break;
	case SOAP_TYPE_ns__conversionNestedArray:
		soap_serialize_ns__conversionNestedArray(soap, (const struct ns__conversionNestedArray *)ptr);
		break;
	case SOAP_TYPE_ns__conversionNestedArrayResponse:
		soap_serialize_ns__conversionNestedArrayResponse(soap, (const struct ns__conversionNestedArrayResponse *)ptr);
		break;
	case SOAP_TYPE_ns__conversionByteArray:
		soap_serialize_ns__conversionByteArray(soap, (const struct ns__conversionByteArray *)ptr);
		break;
	case SOAP_TYPE_ns__conversionByteArrayResponse:
		soap_serialize_ns__conversionByteArrayResponse(soap, (const struct ns__conversionByteArrayResponse *)ptr);
		break;
	case SOAP_TYPE_ComplexType:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__conversionNestedArray(struct soap *soap, const struct ns__conversionNestedArray *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_ComplexType(soap, &a->in);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__conversionNestedArray(struct soap *soap, struct ns__conversionNestedArray *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_ComplexType(soap, &a->in);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__conversionNestedArray(struct soap *soap, const struct ns__conversionNestedArray *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_ns__conversionNestedArray);
	soap->stats->start ();
	if (soap_out_ns__conversionNestedArray(soap, tag, id, a, type))
		return soap->error;
	soap->stats->stop ();
	soap->stats->pair_sample_usecs ();
	return soap_putindependent(soap);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__conversionNestedArray(struct soap *soap, const char *tag, int id, const struct ns__conversionNestedArray *a, const char *type)
{
	soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__conversionNestedArray), type);
	soap_out_ComplexType(soap, "ns:in", -1, &a->in, "");
	soap_element_end_out(soap, tag);
	return SOAP_OK;
}

SOAP_FMAC3 struct ns__conversionNestedArray * SOAP_FMAC4 soap_get_ns__conversionNestedArray(struct soap *soap, struct ns__conversionNestedArray *p, const char *tag, const char *type)
{
	if ((p = soap_in_ns__conversionNestedArray(soap, tag, p, type)))
		soap_getindependent(soap);
	return p;
}

SOAP_FMAC3 struct ns__conversionNestedArray * SOAP_FMAC4 soap_in_ns__conversionNestedArray(struct soap *soap, const char *tag, struct ns__conversionNestedArray *a, const char *type)
{
	...
	a = (struct ns__conversionNestedArray *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns__conversionNestedArray, sizeof(struct ns__conversionNestedArray), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_ns__conversionNestedArray(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			{
			  soap->stats->start ();
			  gSOAP_outer_array *tmp = soap_in_ComplexType(soap, "ns:in", &a->in, "Outer");
			  soap->stats->stop ();
			  soap->stats->sample_usecs ();
				if (tmp)
				{	soap_flag_in--;
					continue;
				}
	...
	{	a = (struct ns__conversionNestedArray *)soap_id_forward(soap, soap->href, (void**)a, SOAP_TYPE_ns__conversionNestedArray, 0, sizeof(struct ns__conversionNestedArray), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__conversionNestedArrayResponse(struct soap *soap, const struct ns__conversionNestedArrayResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__conversionNestedArrayResponse(struct soap *soap, struct ns__conversionNestedArrayResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_unsignedLong(soap, &a->seq_num);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__conversionNestedArrayResponse(struct soap *soap, const struct ns__conversionNestedArrayResponse *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_ns__conversionNestedArrayResponse);
	if (soap_out_ns__conversionNestedArrayResponse(soap, tag, id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__conversionNestedArrayResponse(struct soap *soap, const char *tag, int id, const struct ns__conversionNestedArrayResponse *a, const char *type)
{
	soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__conversionNestedArrayResponse), type);
...
SOAP_FMAC3 struct ns__conversionNestedArrayResponse * SOAP_FMAC4 soap_get_ns__conversionNestedArrayResponse(struct soap *soap, struct ns__conversionNestedArrayResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in_ns__conversionNestedArrayResponse(soap, tag, p, type)))
		soap_getindependent(soap);
	return p;
}

SOAP_FMAC3 struct ns__conversionNestedArrayResponse * SOAP_FMAC4 soap_in_ns__conversionNestedArrayResponse(struct soap *soap, const char *tag, struct ns__conversionNestedArrayResponse *a, const char *type)
{
	...
	a = (struct ns__conversionNestedArrayResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns__conversionNestedArrayResponse, sizeof(struct ns__conversionNestedArrayResponse), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_ns__conversionNestedArrayResponse(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct ns__conversionNestedArrayResponse *)soap_id_forward(soap, soap->href, (void**)a, SOAP_TYPE_ns__conversionNestedArrayResponse, 0, sizeof(struct ns__conversionNestedArrayResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__conversionByteArray(struct soap *soap, const struct ns__conversionByteArray *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_ByteArray(soap, &a->in);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__conversionByteArray(struct soap *soap, struct ns__conversionByteArray *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_ByteArray(soap, &a->in);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__conversionByteArray(struct soap *soap, const struct ns__conversionByteArray *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_ns__conversionByteArray);
	soap->stats->start ();
	if (soap_out_ns__conversionByteArray(soap, tag, id, a, type))
		return soap->error;
	soap->stats->stop ();
	soap->stats->pair_sample_usecs ();
	return soap_putindependent(soap);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__conversionByteArray(struct soap *soap, const char *tag, int id, const struct ns__conversionByteArray *a, const char *type)
{
	soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__conversionByteArray), type);
	soap_out_ByteArray(soap, "ns:in", -1, &a->in, "");
	soap_element_end_out(soap, tag);
	return SOAP_OK;
}

SOAP_FMAC3 struct ns__conversionByteArray * SOAP_FMAC4 soap_get_ns__conversionByteArray(struct soap *soap, struct ns__conversionByteArray *p, const char *tag, const char *type)
{
	p = soap_in_ns__conversionByteArray(soap, tag, p, type);
	if ((p))
		soap_getindependent(soap);
	return p;
}

SOAP_FMAC3 struct ns__conversionByteArray * SOAP_FMAC4 soap_in_ns__conversionByteArray(struct soap *soap, const char *tag, struct ns__conversionByteArray *a, const char *type)
{
	short soap_flag_in = 1;
	if (soap_element_begin_in(soap, tag, 0))
		return NULL;
	...
	a = (struct ns__conversionByteArray *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns__conversionByteArray, sizeof(struct ns__conversionByteArray), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_ns__conversionByteArray(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			{
			  soap->stats->start ();
			  gSOAP_byte_array *tmp = soap_in_ByteArray(soap, "ns:in", &a->in, "xsd:byte");
			  soap->stats->stop ();
			  soap->stats->sample_usecs ();
				if (tmp)
				{	soap_flag_in--;
	...
	{	a = (struct ns__conversionByteArray *)soap_id_forward(soap, soap->href, (void**)a, SOAP_TYPE_ns__conversionByteArray, 0, sizeof(struct ns__conversionByteArray), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__conversionByteArrayResponse(struct soap *soap, const struct ns__conversionByteArrayResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__conversionByteArrayResponse(struct soap *soap, struct ns__conversionByteArrayResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_unsignedLong(soap, &a->seq_num);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__conversionByteArrayResponse(struct soap *soap, const struct ns__conversionByteArrayResponse *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_ns__conversionByteArrayResponse);
	if (soap_out_ns__conversionByteArrayResponse(soap, tag, id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__conversionByteArrayResponse(struct soap *soap, const char *tag, int id, const struct ns__conversionByteArrayResponse *a, const char *type)
{
	soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__conversionByteArrayResponse), type);
	soap_element_result(soap, "ns:seq-num");
	soap_out_unsignedLong(soap, "ns:seq-num", -1, &a->seq_num, "");
	soap_element_end_out(soap, tag);
	return SOAP_OK;
...
SOAP_FMAC3 struct ns__conversionByteArrayResponse * SOAP_FMAC4 soap_get_ns__conversionByteArrayResponse(struct soap *soap, struct ns__conversionByteArrayResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in_ns__conversionByteArrayResponse(soap, tag, p, type)))
		soap_getindependent(soap);
	return p;
}

SOAP_FMAC3 struct ns__conversionByteArrayResponse * SOAP_FMAC4 soap_in_ns__conversionByteArrayResponse(struct soap *soap, const char *tag, struct ns__conversionByteArrayResponse *a, const char *type)
{
	short soap_flag_seq_num = 1;
	if (soap_element_begin_in(soap, tag, 0))
		return NULL;
	...
	a = (struct ns__conversionByteArrayResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns__conversionByteArrayResponse, sizeof(struct ns__conversionByteArrayResponse), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_ns__conversionByteArrayResponse(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct ns__conversionByteArrayResponse *)soap_id_forward(soap, soap->href, (void**)a, SOAP_TYPE_ns__conversionByteArrayResponse, 0, sizeof(struct ns__conversionByteArrayResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
