...
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__conversionNestedArray(struct soap*, const struct ns__conversionNestedArray *);
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__conversionNestedArray(struct soap*, struct ns__conversionNestedArray *);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__conversionNestedArray(struct soap*, const struct ns__conversionNestedArray *, const char*, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__conversionNestedArray(struct soap*, const char*, int, const struct ns__conversionNestedArray *, const char*);
SOAP_FMAC3 struct ns__conversionNestedArray * SOAP_FMAC4 soap_get_ns__conversionNestedArray(struct soap*, struct ns__conversionNestedArray *, const char*, const char*);
SOAP_FMAC3 struct ns__conversionNestedArray * SOAP_FMAC4 soap_in_ns__conversionNestedArray(struct soap*, const char*, struct ns__conversionNestedArray *, const char*);

#ifndef SOAP_TYPE_ns__conversionNestedArrayResponse
#define SOAP_TYPE_ns__conversionNestedArrayResponse (26)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__conversionNestedArrayResponse(struct soap*, const struct ns__conversionNestedArrayResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__conversionNestedArrayResponse(struct soap*, struct ns__conversionNestedArrayResponse *);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__conversionNestedArrayResponse(struct soap*, const struct ns__conversionNestedArrayResponse *, const char*, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__conversionNestedArrayResponse(struct soap*, const char*, int, const struct ns__conversionNestedArrayResponse *, const char*);
SOAP_FMAC3 struct ns__conversionNestedArrayResponse * SOAP_FMAC4 soap_get_ns__conversionNestedArrayResponse(struct soap*, struct ns__conversionNestedArrayResponse *, const char*, const char*);
SOAP_FMAC3 struct ns__conversionNestedArrayResponse * SOAP_FMAC4 soap_in_ns__conversionNestedArrayResponse(struct soap*, const char*, struct ns__conversionNestedArrayResponse *, const char*);

#ifndef SOAP_TYPE_ns__conversionByteArray
#define SOAP_TYPE_ns__conversionByteArray (24)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__conversionByteArray(struct soap*, const struct ns__conversionByteArray *);
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__conversionByteArray(struct soap*, struct ns__conversionByteArray *);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__conversionByteArray(struct soap*, const struct ns__conversionByteArray *, const char*, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__conversionByteArray(struct soap*, const char*, int, const struct ns__conversionByteArray *, const char*);
SOAP_FMAC3 struct ns__conversionByteArray * SOAP_FMAC4 soap_get_ns__conversionByteArray(struct soap*, struct ns__conversionByteArray *, const char*, const char*);
SOAP_FMAC3 struct ns__conversionByteArray * SOAP_FMAC4 soap_in_ns__conversionByteArray(struct soap*, const char*, struct ns__conversionByteArray *, const char*);

#ifndef SOAP_TYPE_ns__conversionByteArrayResponse
#define SOAP_TYPE_ns__conversionByteArrayResponse (23)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__conversionByteArrayResponse(struct soap*, const struct ns__conversionByteArrayResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__conversionByteArrayResponse(struct soap*, struct ns__conversionByteArrayResponse *);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__conversionByteArrayResponse(struct soap*, const struct ns__conversionByteArrayResponse *, const char*, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__conversionByteArrayResponse(struct soap*, const char*, int, const struct ns__conversionByteArrayResponse *, const char*);
SOAP_FMAC3 struct ns__conversionByteArrayResponse * SOAP_FMAC4 soap_get_ns__conversionByteArrayResponse(struct soap*, struct ns__conversionByteArrayResponse *, const char*, const char*);
SOAP_FMAC3 struct ns__conversionByteArrayResponse * SOAP_FMAC4 soap_in_ns__conversionByteArrayResponse(struct soap*, const char*, struct ns__conversionByteArrayResponse *, const char*);
