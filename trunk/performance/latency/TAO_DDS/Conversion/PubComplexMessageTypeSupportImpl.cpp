// -*- C++ -*-
//
// $Id: CPPTemplate.pm,v 1.11 2005/10/23 23:24:11 fields_t Exp $
...
PubComplexMessageTypeSupportImpl::PubComplexMessageTypeSupportImpl (void)
{
}
...
DDS::ReturnCode_t
PubComplexMessageTypeSupportImpl::register_type (
...
PubComplexMessageTypeSupportImpl::create_datawriter (
...
{
    PubComplexMessageDataWriterImpl* writer_impl;
...
PubComplexMessageTypeSupportImpl::create_datareader (
    ACE_ENV_SINGLE_ARG_DECL
  )
  ACE_THROW_SPEC ((
    CORBA::SystemException
...
{
    PubComplexMessageDataReaderImpl* reader_impl;
...
// Implementation skeleton constructor
PubComplexMessageDataWriterImpl::PubComplexMessageDataWriterImpl (void)
: marshaled_size_ (0),
  db_lock_pool_(0),
  data_allocator_ (0),
  mb_allocator_ (0),
...
PubComplexMessageDataWriterImpl::_cxx_register (
...
DDS::InstanceHandle_t 
PubComplexMessageDataWriterImpl::register_w_timestamp (
    const ::DDSPerfTest::PubComplexMessage & instance_data,
  ...
  ))
{
  ...
  if (ret != ::DDS::RETCODE_OK)
  {
      ACE_ERROR ((LM_ERROR, 
                  ACE_TEXT("(%P|%t) ")
                  ACE_TEXT("PubComplexMessageDataWriterImpl::register_w_timestamp, ")
...
DDS::ReturnCode_t
PubComplexMessageDataWriterImpl::unregister (
    const ::DDSPerfTest::PubComplexMessage & instance_data,
    ::DDS::InstanceHandle_t handle
    ACE_ENV_ARG_DECL
  )
...
DDS::ReturnCode_t
PubComplexMessageDataWriterImpl::unregister_w_timestamp (
    const ::DDSPerfTest::PubComplexMessage & instance_data,
    ::DDS::InstanceHandle_t handle,
    const ::DDS::Time_t & source_timestamp
    ACE_ENV_ARG_DECL
  ...
  ))
{
  ...
  if(registered_handle == ::TAO::DCPS::HANDLE_NIL)
  {
    ...
    ACE_ERROR_RETURN ((LM_ERROR, 
                        ACE_TEXT("(%P|%t) ")
                        ACE_TEXT("PubComplexMessageDataWriterImpl::unregister, ")
  ...
  {
    // DataWriterImpl::unregister will call back to inform the PubComplexMessageDataWriter
    // that the instance handle is removed from there and hence PubComplexMessageDataWriter
...
DDS::ReturnCode_t
PubComplexMessageDataWriterImpl::write (
    const ::DDSPerfTest::PubComplexMessage & instance_data,
    ::DDS::InstanceHandle_t handle
    ACE_ENV_ARG_DECL
  )
...
DDS::ReturnCode_t
PubComplexMessageDataWriterImpl::write_w_timestamp (
    const ::DDSPerfTest::PubComplexMessage & instance_data,
    ::DDS::InstanceHandle_t handle,
    const ::DDS::Time_t & source_timestamp
    ACE_ENV_ARG_DECL
  ...
  ))
{
  ...
  if (handle == ::DDS::HANDLE_NIL)
  {
    ...
    if (ret != ::DDS::RETCODE_OK)
    {
      ACE_ERROR ((LM_ERROR, 
                  ACE_TEXT("(%P|%t) ")
                  ACE_TEXT("PubComplexMessageDataWriterImpl::write, ")
...
DDS::ReturnCode_t
PubComplexMessageDataWriterImpl::dispose (
    const ::DDSPerfTest::PubComplexMessage & instance_data,
...
DDS::ReturnCode_t
PubComplexMessageDataWriterImpl::dispose_w_timestamp (
    const ::DDSPerfTest::PubComplexMessage & instance_data,
    ::DDS::InstanceHandle_t instance_handle,
    const ::DDS::Time_t & source_timestamp
    ACE_ENV_ARG_DECL
  ...
  ))
{
  ...
  if(instance_handle == ::TAO::DCPS::HANDLE_NIL) 
  {
    ...
    if (instance_handle == ::TAO::DCPS::HANDLE_NIL) 
    {
      ACE_ERROR_RETURN ((LM_ERROR, 
                          ACE_TEXT("(%P|%t) ")
                          ACE_TEXT("PubComplexMessageDataWriterImpl::dispose, ")
...
DDS::ReturnCode_t
PubComplexMessageDataWriterImpl::get_key_value (
...
void
PubComplexMessageDataWriterImpl::init (
      ::DDS::Topic_ptr                       topic,
    ...
    ))
{
  ...
  ::DDSPerfTest::PubComplexMessage data;
...
::DDS::ReturnCode_t 
PubComplexMessageDataWriterImpl::enable_specific (
    ACE_ENV_SINGLE_ARG_DECL
  )
  ACE_THROW_SPEC ((
    CORBA::SystemException
  ))
{
  ...
  if (_tao_is_bounded_size (data))
  {
    ...
    if (::TAO::DCPS::DCPS_debug_level >= 2)
      ACE_DEBUG((LM_DEBUG,"(%P|%t) PubComplexMessageDataWriterImpl::enable_specific-data"
  ...
  {
    if (::TAO::DCPS::DCPS_debug_level >= 2)
      ACE_DEBUG((LM_DEBUG,"(%P|%t) PubComplexMessageDataWriterImpl::enable_specific"
  ...
  if (::TAO::DCPS::DCPS_debug_level >= 2)
    {
      ACE_DEBUG((LM_DEBUG,"(%P|%t) PubComplexMessageDataWriterImpl::enable_specific-mb"
          " Cached_Allocator_With_Overflow %x with %d chunks\n",
          mb_allocator_, n_chunks_));
      ACE_DEBUG((LM_DEBUG,"(%P|%t) PubComplexMessageDataWriterImpl::enable_specific-db"
          " Cached_Allocator_With_Overflow %x with %d chunks\n",
...
// Note: The PubComplexMessageDataWriter gives ownership of the marshalled data 
//       to the WriteDataContainer.
ACE_Message_Block*
 PubComplexMessageDataWriterImpl::marshal(
                const ::DDSPerfTest::PubComplexMessage& instance_data,
                int  for_write)
{
  ...
  { // Don't use the cached allocator for the registered sample message
    ...
    ACE_NEW_RETURN (mb,
                    ACE_Message_Block (sizeof (::DDSPerfTest::PubComplexMessage)),
                    0);
  }
...
::DDS::ReturnCode_t
 PubComplexMessageDataWriterImpl::get_or_create_instance_handle(
                DDS::InstanceHandle_t& handle,
      ...
      if (pair.second == false)
        {
          ACE_ERROR_RETURN ((LM_ERROR, 
                              ACE_TEXT("(%P|%t) "
                              "PubComplexMessageDataWriterImpl::get_or_create_instance_handle, ")
                              ACE_TEXT("insert DDSPerfTest::PubComplexMessage failed. \n")),
                              ::DDS::RETCODE_ERROR);
        }
    }
    else
...
::DDS::InstanceHandle_t 
 PubComplexMessageDataWriterImpl::get_instance_handle(
                ::DDSPerfTest::PubComplexMessage instance_data)
{
  InstanceMap::const_iterator it = instance_map_.find(instance_data);
...
void
PubComplexMessageDataWriterImpl::unregistered(::DDS::InstanceHandle_t   instance_handle)
{
...
// Implementation skeleton constructor
PubComplexMessageDataReaderImpl::PubComplexMessageDataReaderImpl (void)
{

}

void
PubComplexMessageDataReaderImpl::init (
        TopicImpl*                    a_topic,
...
::DDS::ReturnCode_t 
PubComplexMessageDataReaderImpl::enable_specific (
    ACE_ENV_SINGLE_ARG_DECL
  )
  ACE_THROW_SPEC ((
    CORBA::SystemException
  ))
{
  data_allocator_ = new DataAllocator(get_n_chunks ()) ;
    if (::TAO::DCPS::DCPS_debug_level >= 2)
      ACE_DEBUG((LM_DEBUG,"PubComplexMessageDataReaderImpl::enable_specific-data"
          " Cached_Allocator_With_Overflow %x with %d chunks\n",
      ...
      while (ptr->rcvd_sample_.size_)
        {
         ...
         ::DDSPerfTest::PubComplexMessage* delete_ptr = static_cast< ::DDSPerfTest::PubComplexMessage* >(head_ptr->registered_data_);
...
DDS::ReturnCode_t
PubComplexMessageDataReaderImpl::delete_contained_entities (
    ACE_ENV_SINGLE_ARG_DECL
  )
  ACE_THROW_SPEC ((
    CORBA::SystemException
...
// :: 
DDS::ReturnCode_t 
PubComplexMessageDataReaderImpl::read (
  ...
  ))
{
  ...
  if (received_data.maximum() == 0)
    {
      ::DDSPerfTest::PubComplexMessage *buf;
      ::DDS::SampleInfo *info;
      buf = new ::DDSPerfTest::PubComplexMessage[max_samples];
       ...
       it ++)
  {
        ...
        (ptr->instance_state_.instance_state() & instance_states))
    {
           ...
           item != 0 ; item = item->next_data_sample_)
      {
        ...
        {
          received_data[count] =
              *((::DDSPerfTest::PubComplexMessage *)item->registered_data_) ;
...
DDS::ReturnCode_t 
PubComplexMessageDataReaderImpl::take (
    ::PubComplexMessageSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::SampleStateMask sample_states,
          ...
          if (item->sample_state_ & sample_states)
            {
              ...
              if (item == ptr->rcvd_sample_.tail_)
              ...
              else
                {
                 ...
                 ::DDSPerfTest::PubComplexMessage* delete_ptr = static_cast< ::DDSPerfTest::PubComplexMessage* >(item->registered_data_);
                  ACE_DES_FREE (delete_ptr,
                                data_allocator_->free,
                                PubComplexMessage );
                  ACE_DES_FREE (item,
        ...
        if (tail)
          {
            ...
            ::DDSPerfTest::PubComplexMessage* delete_ptr = static_cast< ::DDSPerfTest::PubComplexMessage* >(tail->registered_data_);
            ACE_DES_FREE (delete_ptr,
                          data_allocator_->free,
                          PubComplexMessage );
            ACE_DES_FREE (tail,
...
DDS::ReturnCode_t
PubComplexMessageDataReaderImpl::read_next_sample (
  ...
  ))
{
  ...
  FILE* fp =
    ACE_OS::fopen ("PubComplexMessage.txt", ACE_LIB_TEXT("r"));
  if (fp == 0)
  {
    ACE_ERROR_RETURN ((LM_ERROR, 
                        ACE_TEXT("(%P|%t) ")
                        ACE_TEXT("PubComplexMessageDataReaderImpl::read_next_sample, ")
                        ACE_TEXT("Unable to open PubComplexMessage.txt for reading: %p\n"),
                        "fopen"),
                        ::DDS::RETCODE_ERROR);
  }
  ...
  ::PubComplexMessageSeq received_data_seq(1) ;
...
DDS::ReturnCode_t
PubComplexMessageDataReaderImpl::take_next_sample (
    ::DDSPerfTest::PubComplexMessage & received_data,
    ::DDS::SampleInfo & sample_info
    ACE_ENV_ARG_DECL
  )
...
DDS::ReturnCode_t
PubComplexMessageDataReaderImpl::read_instance (
    ::PubComplexMessageSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
...
DDS::ReturnCode_t
PubComplexMessageDataReaderImpl::take_instance (
    ::PubComplexMessageSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
DDS::ReturnCode_t
PubComplexMessageDataReaderImpl::read_next_instance (
    ::PubComplexMessageSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
DDS::ReturnCode_t
PubComplexMessageDataReaderImpl::take_next_instance (
    ::PubComplexMessageSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
DDS::ReturnCode_t
PubComplexMessageDataReaderImpl::return_loan (
    ::PubComplexMessageSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq
    ACE_ENV_ARG_DECL
  )
  ...
  ))
{
  ...
  {
    ::DDSPerfTest::PubComplexMessage *buf = received_data.get_buffer();
...
DDS::ReturnCode_t 
PubComplexMessageDataReaderImpl::get_key_value (
    ::DDSPerfTest::PubComplexMessage & key_holder,
    ::DDS::InstanceHandle_t handle
    ACE_ENV_ARG_DECL
  )
...
void
PubComplexMessageDataReaderImpl::demarshal(const ReceivedDataSample& sample)
{
  ::DDSPerfTest::PubComplexMessage *data /* = new ::DDSPerfTest::PubComplexMessage(instance_data) */ ;
  
  ACE_NEW_MALLOC_NORETURN (data,
                         static_cast< ::DDSPerfTest::PubComplexMessage *> (
                         data_allocator_->malloc (
                              sizeof (::DDSPerfTest::PubComplexMessage))),
...
::DDS::ReturnCode_t
PubComplexMessageDataReaderImpl::store_instance_data(
    ::DDSPerfTest::PubComplexMessage *instance_data,
        ...
        this->qos_.resource_limits.max_samples_per_instance))
    {
      if  (instance_ptr->rcvd_sample_.head_->sample_state_ 
       ...
       else
       {
         ...
         ::DDSPerfTest::PubComplexMessage* ptr = static_cast< ::DDSPerfTest::PubComplexMessage* >(item->registered_data_);
         ACE_DES_FREE (ptr,
                       data_allocator_->free,
                       PubComplexMessage );
...
void 
PubComplexMessageDataReaderImpl::dispose(const ReceivedDataSample& sample)
{
  //!!! caller should already have the sample_lock_
  ...
  else
  {
    ACE_ERROR((LM_ERROR, 
              ACE_TEXT("(%P|%t) ")
              ACE_TEXT("PubComplexMessageDataReaderImpl::disposed, ")
              ACE_TEXT("The instance is not registered.\n")));
  }
...
//TAO::DCPS::DataReaderRemote_ptr
//PubComplexMessageDataReaderImpl::get_datareaderremote_obj_ref ()
//{
//  ::TAO::DCPS::DataReaderRemote_ptr reader_obj 
//      = ::TAO::DCPS::servant_to_reference<TAO::DCPS::DataReaderRemote, 
//                                          PubComplexMessageDataReaderImpl, 
