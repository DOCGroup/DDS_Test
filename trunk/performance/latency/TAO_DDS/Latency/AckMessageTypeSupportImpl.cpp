...
AckMessageTypeSupportImpl::AckMessageTypeSupportImpl (void)
{
}
...
DDS::ReturnCode_t
AckMessageTypeSupportImpl::register_type (
...
AckMessageTypeSupportImpl::create_datawriter (
...
{
    AckMessageDataWriterImpl* writer_impl;
    ACE_NEW_RETURN(writer_impl, 
                   AckMessageDataWriterImpl(), 
...
AckMessageTypeSupportImpl::create_datareader (
    ACE_ENV_SINGLE_ARG_DECL
  )
  ACE_THROW_SPEC ((
    CORBA::SystemException
...
{
    AckMessageDataReaderImpl* reader_impl;
    ACE_NEW_RETURN(reader_impl, 
                    AckMessageDataReaderImpl(), 
...
// Implementation skeleton constructor
AckMessageDataWriterImpl::AckMessageDataWriterImpl (void)
: marshaled_size_ (0),
  db_lock_pool_(0),
  data_allocator_ (0),
  mb_allocator_ (0),
...
AckMessageDataWriterImpl::_cxx_register (
...
DDS::InstanceHandle_t 
AckMessageDataWriterImpl::register_w_timestamp (
    const ::DDSPerfTest::AckMessage & instance_data,
  ...
  ))
{
  ...
  if (ret != ::DDS::RETCODE_OK)
  {
      ACE_ERROR ((LM_ERROR, 
                  ACE_TEXT("(%P|%t) ")
                  ACE_TEXT("AckMessageDataWriterImpl::register_w_timestamp, ")
...
DDS::ReturnCode_t
AckMessageDataWriterImpl::unregister (
    const ::DDSPerfTest::AckMessage & instance_data,
    ::DDS::InstanceHandle_t handle
    ACE_ENV_ARG_DECL
  )
...
DDS::ReturnCode_t
AckMessageDataWriterImpl::unregister_w_timestamp (
    const ::DDSPerfTest::AckMessage & instance_data,
    ::DDS::InstanceHandle_t handle,
    const ::DDS::Time_t & source_timestamp
    ACE_ENV_ARG_DECL
  ...
  ))
{
  ...
  if(registered_handle == ::TAO::DCPS::HANDLE_NIL)
  {
    ...
    ACE_ERROR_RETURN ((LM_ERROR, 
                        ACE_TEXT("(%P|%t) ")
                        ACE_TEXT("AckMessageDataWriterImpl::unregister, ")
  ...
  {
    // DataWriterImpl::unregister will call back to inform the AckMessageDataWriter
    // that the instance handle is removed from there and hence AckMessageDataWriter
...
DDS::ReturnCode_t
AckMessageDataWriterImpl::write (
    const ::DDSPerfTest::AckMessage & instance_data,
    ::DDS::InstanceHandle_t handle
    ACE_ENV_ARG_DECL
  )
...
DDS::ReturnCode_t
AckMessageDataWriterImpl::write_w_timestamp (
    const ::DDSPerfTest::AckMessage & instance_data,
    ::DDS::InstanceHandle_t handle,
    const ::DDS::Time_t & source_timestamp
    ACE_ENV_ARG_DECL
  ...
  ))
{
  ...
  if (handle == ::DDS::HANDLE_NIL)
  {
    ...
    if (ret != ::DDS::RETCODE_OK)
    {
      ACE_ERROR ((LM_ERROR, 
                  ACE_TEXT("(%P|%t) ")
                  ACE_TEXT("AckMessageDataWriterImpl::write, ")
...
DDS::ReturnCode_t
AckMessageDataWriterImpl::dispose (
    const ::DDSPerfTest::AckMessage & instance_data,
...
DDS::ReturnCode_t
AckMessageDataWriterImpl::dispose_w_timestamp (
    const ::DDSPerfTest::AckMessage & instance_data,
    ::DDS::InstanceHandle_t instance_handle,
    const ::DDS::Time_t & source_timestamp
    ACE_ENV_ARG_DECL
  ...
  ))
{
  ...
  if(instance_handle == ::TAO::DCPS::HANDLE_NIL) 
  {
    ...
    if (instance_handle == ::TAO::DCPS::HANDLE_NIL) 
    {
      ACE_ERROR_RETURN ((LM_ERROR, 
                          ACE_TEXT("(%P|%t) ")
                          ACE_TEXT("AckMessageDataWriterImpl::dispose, ")
...
DDS::ReturnCode_t
AckMessageDataWriterImpl::get_key_value (
...
::DDS::ReturnCode_t 
AckMessageDataWriterImpl::enable_specific (
    ACE_ENV_SINGLE_ARG_DECL
  )
  ACE_THROW_SPEC ((
    CORBA::SystemException
  ))
{
  ...
  if (_tao_is_bounded_size (data))
  {
    ...
    if (::TAO::DCPS::DCPS_debug_level >= 2)
      ACE_DEBUG((LM_DEBUG,"(%P|%t) AckMessageDataWriterImpl::enable_specific-data"
  ...
  {
    if (::TAO::DCPS::DCPS_debug_level >= 2)
      ACE_DEBUG((LM_DEBUG,"(%P|%t) AckMessageDataWriterImpl::enable_specific"
  ...
  if (::TAO::DCPS::DCPS_debug_level >= 2)
    {
      ACE_DEBUG((LM_DEBUG,"(%P|%t) AckMessageDataWriterImpl::enable_specific-mb"
          " Cached_Allocator_With_Overflow %x with %d chunks\n",
          mb_allocator_, n_chunks_));
      ACE_DEBUG((LM_DEBUG,"(%P|%t) AckMessageDataWriterImpl::enable_specific-db"
          " Cached_Allocator_With_Overflow %x with %d chunks\n",
...
// Note: The AckMessageDataWriter gives ownership of the marshalled data 
//       to the WriteDataContainer.
ACE_Message_Block*
 AckMessageDataWriterImpl::marshal(
                const ::DDSPerfTest::AckMessage& instance_data,
                int  for_write)
{
  ...
  { // Don't use the cached allocator for the registered sample message
    ...
    ACE_NEW_RETURN (mb,
                    ACE_Message_Block (sizeof (::DDSPerfTest::AckMessage)),
                    0);
  }
...
::DDS::ReturnCode_t
 AckMessageDataWriterImpl::get_or_create_instance_handle(
                DDS::InstanceHandle_t& handle,
      ...
      if (pair.second == false)
        {
          ACE_ERROR_RETURN ((LM_ERROR, 
                              ACE_TEXT("(%P|%t) "
                              "AckMessageDataWriterImpl::get_or_create_instance_handle, ")
                              ACE_TEXT("insert DDSPerfTest::AckMessage failed. \n")),
                              ::DDS::RETCODE_ERROR);
        }
    }
    else
...
::DDS::InstanceHandle_t 
 AckMessageDataWriterImpl::get_instance_handle(
                ::DDSPerfTest::AckMessage instance_data)
{
  InstanceMap::const_iterator it = instance_map_.find(instance_data);
...
void
AckMessageDataWriterImpl::unregistered(::DDS::InstanceHandle_t   instance_handle)
{
...
// Implementation skeleton constructor
AckMessageDataReaderImpl::AckMessageDataReaderImpl (void)
{

}

void
AckMessageDataReaderImpl::init (
        TopicImpl*                    a_topic,
...
::DDS::ReturnCode_t 
AckMessageDataReaderImpl::enable_specific (
    ACE_ENV_SINGLE_ARG_DECL
  )
  ACE_THROW_SPEC ((
    CORBA::SystemException
  ))
{
  data_allocator_ = new DataAllocator(get_n_chunks ()) ;
    if (::TAO::DCPS::DCPS_debug_level >= 2)
      ACE_DEBUG((LM_DEBUG,"AckMessageDataReaderImpl::enable_specific-data"
          " Cached_Allocator_With_Overflow %x with %d chunks\n",
      ...
      while (ptr->rcvd_sample_.size_)
        {
         ...
         ::DDSPerfTest::AckMessage* delete_ptr = static_cast< ::DDSPerfTest::AckMessage* >(head_ptr->registered_data_);
...
DDS::ReturnCode_t
AckMessageDataReaderImpl::delete_contained_entities (
    ACE_ENV_SINGLE_ARG_DECL
  )
  ACE_THROW_SPEC ((
    CORBA::SystemException
  ...
  ))
{
  ...
  if (received_data.maximum() == 0)
    {
      ::DDSPerfTest::AckMessage *buf;
      ::DDS::SampleInfo *info;
      buf = new ::DDSPerfTest::AckMessage[max_samples];
       ...
       it ++)
  {
        ...
        (ptr->instance_state_.instance_state() & instance_states))
    {
           ...
           item != 0 ; item = item->next_data_sample_)
      {
        ...
        {
          received_data[count] =
              *((::DDSPerfTest::AckMessage *)item->registered_data_) ;
          ...
          if (item->sample_state_ & sample_states)
            {
              ...
              if (item == ptr->rcvd_sample_.tail_)
              ...
              else
                {
                 ...
                 ::DDSPerfTest::AckMessage* delete_ptr = static_cast< ::DDSPerfTest::AckMessage* >(item->registered_data_);
                  ACE_DES_FREE (delete_ptr,
                                data_allocator_->free,
                                AckMessage );
                  ACE_DES_FREE (item,
        ...
        if (tail)
          {
            ...
            ::DDSPerfTest::AckMessage* delete_ptr = static_cast< ::DDSPerfTest::AckMessage* >(tail->registered_data_);
            ACE_DES_FREE (delete_ptr,
                          data_allocator_->free,
                          AckMessage );
            ACE_DES_FREE (tail,
...
DDS::ReturnCode_t
AckMessageDataReaderImpl::read_next_sample (
  ...
  ))
{
  ...
  FILE* fp =
    ACE_OS::fopen ("AckMessage.txt", ACE_LIB_TEXT("r"));
  if (fp == 0)
  {
    ACE_ERROR_RETURN ((LM_ERROR, 
                        ACE_TEXT("(%P|%t) ")
                        ACE_TEXT("AckMessageDataReaderImpl::read_next_sample, ")
                        ACE_TEXT("Unable to open AckMessage.txt for reading: %p\n"),
                        "fopen"),
                        ::DDS::RETCODE_ERROR);
  }
  ...
  ::AckMessageSeq received_data_seq(1) ;
...
DDS::ReturnCode_t
AckMessageDataReaderImpl::take_next_sample (
    ::DDSPerfTest::AckMessage & received_data,
    ::DDS::SampleInfo & sample_info
    ACE_ENV_ARG_DECL
  )
...
DDS::ReturnCode_t
AckMessageDataReaderImpl::read_instance (
    ::AckMessageSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
...
DDS::ReturnCode_t
AckMessageDataReaderImpl::take_instance (
    ::AckMessageSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
DDS::ReturnCode_t
AckMessageDataReaderImpl::read_next_instance (
    ::AckMessageSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
DDS::ReturnCode_t
AckMessageDataReaderImpl::take_next_instance (
    ::AckMessageSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
DDS::ReturnCode_t
AckMessageDataReaderImpl::return_loan (
    ::AckMessageSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq
    ACE_ENV_ARG_DECL
  )
  ...
  ))
{
  ...
  {
    ::DDSPerfTest::AckMessage *buf = received_data.get_buffer();
...
DDS::ReturnCode_t 
AckMessageDataReaderImpl::get_key_value (
    ::DDSPerfTest::AckMessage & key_holder,
    ::DDS::InstanceHandle_t handle
    ACE_ENV_ARG_DECL
  )
...
void
AckMessageDataReaderImpl::demarshal(const ReceivedDataSample& sample)
{
  ::DDSPerfTest::AckMessage *data /* = new ::DDSPerfTest::AckMessage(instance_data) */ ;
  
  ACE_NEW_MALLOC_NORETURN (data,
                         static_cast< ::DDSPerfTest::AckMessage *> (
                         data_allocator_->malloc (
                              sizeof (::DDSPerfTest::AckMessage))),
...
::DDS::ReturnCode_t
AckMessageDataReaderImpl::store_instance_data(
    ::DDSPerfTest::AckMessage *instance_data,
        ...
        this->qos_.resource_limits.max_samples_per_instance))
    {
      if  (instance_ptr->rcvd_sample_.head_->sample_state_ 
       ...
       else
       {
         ...
         ::DDSPerfTest::AckMessage* ptr = static_cast< ::DDSPerfTest::AckMessage* >(item->registered_data_);
         ACE_DES_FREE (ptr,
                       data_allocator_->free,
                       AckMessage );
...
void 
AckMessageDataReaderImpl::dispose(const ReceivedDataSample& sample)
{
  //!!! caller should already have the sample_lock_
  ...
  else
  {
    ACE_ERROR((LM_ERROR, 
              ACE_TEXT("(%P|%t) ")
              ACE_TEXT("AckMessageDataReaderImpl::disposed, ")
              ACE_TEXT("The instance is not registered.\n")));
  }
...
//TAO::DCPS::DataReaderRemote_ptr
//AckMessageDataReaderImpl::get_datareaderremote_obj_ref ()
//{
//  ::TAO::DCPS::DataReaderRemote_ptr reader_obj 
//      = ::TAO::DCPS::servant_to_reference<TAO::DCPS::DataReaderRemote, 
//                                          AckMessageDataReaderImpl, 
