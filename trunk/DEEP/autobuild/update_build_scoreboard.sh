...
echo "<tr><td>OpenSplice 2.2.5b02</td><td>build_OpenSplice.sh </td><td bgcolor=\"lime\">[<a href=\"http://www.dre.vanderbilt.edu/DDS/html/BUILD/OpenSplice_BUILD_RESULT\">Full</a>] </td><td bgcolor=\"lime\">[<a href=\"http://www.dre.vanderbilt.edu/DDS/html/BUILD/OpenSplice_TEST_RESULT\">Full</a>]</td><td bgcolor=\"white\">N/A</td></tr>" >> $INDEX_FILE
