...
public:
    ...
    const char  *getName();
    virtual void getValue(const SettingIdentifierType path, unsigned int &value) throw (SettingsParserException);
    virtual void getValue(const SettingIdentifierType path, float &value) throw (SettingsParserException);
    virtual void getValue(const SettingIdentifierType path, bool &value) throw (SettingsParserException);
    virtual void getValue(const SettingIdentifierType path, char *&value) throw (SettingsParserException);
    
	// Pure virtual in base class, must implement to instantiate.
    virtual void getValue(const SettingIdentifierType, unsigned int &, unsigned int) throw (SettingsParserException) {}
    virtual void getValue(const SettingIdentifierType, float &, float) throw (SettingsParserException) {}
    virtual void getValue(const SettingIdentifierType, bool &, bool) throw (SettingsParserException) {}
    virtual void getValue(const SettingIdentifierType, char *&, char *) throw (SettingsParserException) {}
