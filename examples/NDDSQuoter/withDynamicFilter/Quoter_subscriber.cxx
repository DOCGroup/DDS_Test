...
void QuoterListener::on_requested_incompatible_qos(DDSDataReader* reader,
        const DDS_RequestedIncompatibleQosStatus& status)
{
  std::cerr << "on_requested_incompatible_qos error" << std::endl;
}
...
void QuoterListener::on_data_available(DDSDataReader* reader)
{
    ...
    for (i = 0; i < data_seq.length(); ++i) {
        if (info_seq[i].valid_data) {
            ...
            std::cout << "Stock " << data_seq[i].symbol << " = "
